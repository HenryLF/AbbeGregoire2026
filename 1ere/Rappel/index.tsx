    ...
    <>
      ...
      <div className="text">
        ...
        <em>
          ...
          elle même est égale à ce nombre <X />.{" "}
        </em>
      ...
      <p>
        C'est la base de l'algèbre, on écrit une expression avec une inconnue le
        but du jeu est de retrouver la (<em>ou les</em>) valeur(s) de cette
        inconnue.
      </p>
      <div className="text">
        Par exemple :
  ...
  return (
    <>
      ...
      <div className="text">
        ...
        (non nul , càd différent de 0), appelé{" "}
      ...
      <p>
        ...
        ou les prix du chez marchand ou au supermarché (par exemple le prix au
        ...
        <ul>
          ...
          <li className={"break-inside-avoid"}>
            <p>
              ...
              proportionnalité) de farine par oeuf ? De sucre par noix ? De
              sucre par oeuf ?
            </p>
            <DotLine count={3} />
          </li>
          ...
          <li className={"break-inside-avoid"}>
            <p>3. Combien d'oeufs pour 9 et 15 personnes ?</p>
            <DotLine count={3} />
          </li>

          <li className={"break-inside-avoid"}>
            <p>
              4. Utiliser les coefficients de proportionnalité calculer à la
      ...
      <Problem>
        ...
        <div className="w-3/4 block-box ml-auto mr-auto">
          ...
          <div className="w-1/4 text-center">
            ...
            <span className="details italic">Eclipse lunaire</span>
          </div>
        </div>
        <div className="text">
          ...
          <UL className="columns-2 ml-5">
            ...
            <LI>
              Le rayon de la Terre : <LaTeX tex="R_S = 690\:000\: km" />;
            </LI>
            <LI>
  ...
  return (
    <>
      ...
      <div className="text">
        ...
        , on dit alors que <X /> <strong>l'antécédent </strong> de <Fx />.
      </div>
      <ImportantEquation
      ...
      <Note headerText="Mais pourquoi ??">
        Parce que souvent en math on souhaite étudier le comportement d'une
      ...
      <Problem>
        ...
        <OL start={1}>
          ...
          <LI>
            ...
            bleue pour des carrés de côtés <X />, quelle est son expression.
          </LI>
          <DotLine count={3} />
      ...
      <Problem>
        <p>
          Sur un site de e-commerce international, les frais de ports sont fixés
        ...
        <OL>
          ...
          <DotLine count={2} />
          <LI>
            Combien d'objets puis-je acheter pour 60€. Cela revient a résoudre
...
export default function Document() {
  return (
    <html lang="en">
      <head>
        <meta charSet="utf-8" />
        <title>WeasyPrint TSX Template</title>
