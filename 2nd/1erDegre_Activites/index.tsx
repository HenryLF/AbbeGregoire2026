...
import { Call, Circle, Document, Exercice, Img, Interval, Options, SubQuestions, TP } from "@components";
import "./index.css";

const X = () => <LaTeX tex="x" />

export default function PremierDegreActivitesDocument() {
  return (
    <Document title="Résolution de problèmes du 1er degré - Activités">
      ...
      <Exercice title="Équations de base">
        <BlockBox basis={3}>
          {[
            "3=6+x",
            "42 = 6x",
      ...
      <Exercice title="Terrains d'arbres">
        ...
        <LI>
          On appelle <X /> le nombre de châtaigniers. Choisir, parmi les
          propositions suivantes, la manière d’écrire le nombre de chênes :
        </LI>
        <Options>{[
          "x + 4",
          "4x",
        ...
        <DotLine />
        <LI>Sachant que : <LaTeX className="text-xs" tex="nombre\,de\,châtaigniers + nombre\,de\,chênes + nombre\,des\,autres\,arbres = nombre\,total\,d’arbres" />,
      ...
      <Exercice title="Consommations à un bar">
        ...
        <DotLine />
        <LI>
          Exprimer en fonction de <X /> le prix de 3 sodas.
        </LI>
        <DotLine />
        <LI>
      ...
      <Exercice title="Le 3 000 mètres">
        <p>
      ...
      <TP title="Ventes de chaussures de sécurité">
        ...
        <SubQuestions count={2}>
          ...
          <LI>Saisir une formule en D2 pour calculer le total des paires de chaussures de sécurité vendues.</LI>
          <LI>Sélectionner les cellules A2 à D2, puis les copier jusqu’à la ligne 28.</LI>
        </SubQuestions>
      ...
      <TP title="Notion d'intervalle">
        <p>
          Un intervalle de valeurs se note entre crochets. Il existe cependant deux sortes de crochets :
        </p>
        <UL indent={"5mm"} >
        ...
        <Table className={"w-8/10 mx-auto"}>
          ...
          ]}>Représentation graphique</Entry>
          <Entry content={[
            <DotLine />,
            <DotLine />,
            <LaTeX tex="]-2;1]" />
        ...
        <div className="text">
          ...
          La solution d’une inéquation est un ensemble de nombres, noté par un (ou plusieurs) intervalle(s).
        </div>
        <BlockBox>
          <Block ratio={2}>
            <LI>
      ...
      <Exercice title="Palette de parpaing">
        ...
        <LI>
          ...
          masse de la palette vide est de 30 kg et que celle d’un parpaing est de 8 kg.
      ...
      <Exercice title="Frais kilométriques">
        ...
        <SubQuestions count={3}>
          <LI>Donner la relation permettant de calculer les frais remboursés <LaTeX tex="F_A" />  en fonction de <X /> dans l'option <Circle>A</Circle>.</LI>
          <DotLine />
          <LI>Donner la relation permettant de calculer les frais remboursés <LaTeX tex="F_B" />  en fonction de <X /> dans l'option <Circle>B</Circle>.</LI>
          <DotLine />
          <LI>Donner une inéquation traduisant la problématique.</LI>
          <DotLine count={2} />
        </SubQuestions>
