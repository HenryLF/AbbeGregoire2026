...
import { Details, Exemple, Img, ImportantEquation, Problem } from "@components";
import {
  Block,
  BlockBox,
  Chart,
  ...
  return (
    <html lang="en">
      ...
      <body>
        ...
        <BlockBox>
          ...
          <Block>
            <div className="text">
              ...
              <LaTeX>b</LaTeX> étant <strong>inclus</strong> (
              <DotLine inline width="2.5cm" />) dans l’intervalle et{" "}
              <LaTeX>b</LaTeX> <strong>exclus</strong> (
        ...
        <Problem>
          <div className="text">
            Dans la série des tailles d'élève le mode est{" "}
        ...
        <Problem>
          <div className="text question block">
            Dans la série des tailles d'élève la classe modale est{" "}
            <DotLine inline width={"8cm"} />.
          </div>
        </Problem>
        <H2>Moyenne</H2>
        ...
        <p>
          ...
          étendue sur une grande plage de valeur, ou au contraire centrée sur
        ...
        <BlockBox>
          <Block ratio={2}>
            <p>
              ...
              <strong>incertitude</strong>, c'est à dire une plage de valeur
            ...
            <p>
              ...
              permet d'évaluer la précision et donc la fiabilité de cette mesure
              .
            </p>
          </Block>
          <Block>
        ...
        <Problem>
          ...
          <OL format={(n) => `${toLowerAlphabetical(n)})`}>
            <LI>
              A l'aide de la calculatrice ou d'un tableur calculer le temps
              moyen pour un tour.
            </LI>
            <DotLine count={3} />
            <LI>
              A l'aide de la calculatrice ou d'un tableur calculer l'écart-type{" "}
              <LaTeX>{"\\sigma"}</LaTeX>.
            </LI>
            ...
            <LI>
              ...
              où <LaTeX>N</LaTeX> est le nombre de mesure. Donner un encadrement
