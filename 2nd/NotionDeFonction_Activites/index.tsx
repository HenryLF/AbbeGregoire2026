...
import { Circle, Exercice, Img } from "@components";
import "./graphConfig";
    ...
    <html lang="en">
      ...
      <body>
        ...
        <Exercice title="Remplissage de réservoir">
          ...
          <div className="text">
            On remplit d’eau ces solides. On note <X /> la hauteur d’eau de
            liquide dans le récipient. Pour chaque solide, on s’intéresse à la
            fonction qui a <X /> associe le volume d’eau dans le solide.
          </div>
